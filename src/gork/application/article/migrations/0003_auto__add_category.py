...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'article_category', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['article.Category'])),
            ('order_by', self.gf('django.db.models.fields.CharField')(default='-publication_date', max_length=30)),
            ('local_url', self.gf('django.db.models.fields.CharField')(default='', max_length=255, db_index=True, blank=True)),
        ...
        db.create_table(u'article_category_access_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('category', models.ForeignKey(orm['article.category'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(u'article_category_access_groups', ['category_id', 'group_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('article_category_access_groups')
