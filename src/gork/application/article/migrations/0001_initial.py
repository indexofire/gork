...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'article_article', (
            ...
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gauth.GUser'])),
            ('publish_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 16, 0, 0), auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'article', ['Article'])

        # Adding model 'RichTextContent'
        db.create_table(u'article_article_richtextcontent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('feincms.contrib.richtext.RichTextField')(blank=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='richtextcontent_set', to=orm['article.Article'])),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'article', ['RichTextContent'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'article_article_richtextcontent')
