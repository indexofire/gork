...
from docs.settings import *
from docs.projects.exceptions import ProjectImportError
from docs.projects.templatetags.projects_tags import sort_version_aware
...
class Project(models.Model):
    ...
    repo_type = models.CharField(_('Repository type'), max_length=10,
                                 choices=REPO_CHOICES, default='git')
    ...
    theme = models.CharField(
        _('Theme'), max_length=20, choices=DEFAULT_THEME_CHOICES,
    ...
    documentation_type = models.CharField(
        ...
        choices=DOCUMENTATION_CHOICES, default='sphinx',
