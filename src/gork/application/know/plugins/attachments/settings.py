...
ANONYMOUS = getattr(django_settings, 'WIKI_ATTACHMENTS_ANONYMOUS', know_settings.ANONYMOUS_UPLOAD)
...
STORAGE_BACKEND = getattr(django_settings, 'WIKI_ATTACHMENTS_STORAGE_BACKEND', know_settings.STORAGE_BACKEND)
