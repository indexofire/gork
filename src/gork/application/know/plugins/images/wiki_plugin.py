...
from know.plugins.images import views, models, settings, forms
from know.plugins.notifications.settings import ARTICLE_EDIT
from know.plugins.notifications.util import truncate_title
from know.plugins.images.markdown_extensions import ImageExtension
...
class ImagePlugin(BasePlugin):
    ...
    sidebar = {
        ...
        'template': 'know/plugins/images/sidebar.html',
    ...
    class RenderMedia:
        js = [
            'know/colorbox/colorbox/jquery.colorbox-min.js',
            'know/js/images.js',
        ]

        css = {
            'screen': 'know/colorbox/example1/colorbox.css'
        }
