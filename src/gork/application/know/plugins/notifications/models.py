...
from gnotify import notify
from gnotify.models import Subscription
from know import models as wiki_models
from know.models.pluginbase import ArticlePlugin
from know.core.plugins import registry
from know.plugins.notifications import settings
from know.plugins.notifications.util import get_title
...
def default_url(article, urlpath=None):
    try:
        ...
        url = reverse('know:get', kwargs={'path': urlpath.path})
    except wiki_models.URLPath.DoesNotExist:
        url = reverse('know:get', kwargs={'article_id': article.id})
    return url
