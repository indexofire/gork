...
from know.editors.base import BaseEditor
...
class MarkItUpWidget(forms.Widget):
    ...
    def render(self, name, value, attrs=None):
        if value is None:
            value = ''
        final_attrs = self.build_attrs(attrs, name=name)
        return mark_safe(u'<div><textarea%s>%s</textarea></div>' % (flatatt(final_attrs), conditional_escape(force_unicode(value))))
...
class MarkItUp(BaseEditor):
    ...
    class AdminMedia:
        css = {
            'all': (
                "know/markitup/skins/simple/style.css",
                "know/markitup/sets/admin/style.css",
            )
        }
        js = (
            "know/markitup/admin.init.js",
            "know/markitup/jquery.markitup.js",
            "know/markitup/sets/admin/set.js",
        )
    ...
    class Media:
        css = {
            'all': (
                "know/markitup/skins/simple/style.css",
                "know/markitup/sets/frontend/style.css",
            )
        }
        js = (
            "know/markitup/frontend.init.js",
            "know/markitup/jquery.markitup.js",
            "know/markitup/sets/frontend/set.js",
        )
