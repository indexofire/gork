...
from know.core.exceptions import NoRootURL, MultipleRootURLs
from know.models.article import ArticleRevision, ArticleForObject, Article
...
class URLPath(MPTTModel):
    ...
    def get_absolute_url(self):
        return reverse('know:get', kwargs={'path': self.path})
