...
from docs.builds.models import Build, Version
from docs.doc_builder import loading as builder_loading
from doc_builder.base import restoring_chdir
from projects.exceptions import ProjectImportError
from projects.models import ImportedFile, Project
from projects.utils import mkversion, purge_version, run, slugify_uniquely, make_api_version, make_api_project
...
@task
@restoring_chdir
def update_docs(pk, record=True, pdf=True, man=True, epub=True, dash=True, version_pk=None, force=False, **kwargs):
    """
