# -*- coding: utf-8 -*-
from know.utils import get_module
...
def send_alerts(target_dict, response=None, question=None, **kwargs):
    ...
    for email, name in target_dict.items():
        ...
        subject = render_to_string(
            'know/emails/subject.txt', context)

        message = render_to_string(
            'know/emails/message.txt', context)

        message_html = render_to_string(
            'know/emails/message.html', context)
...
def knowledge_post_save(sender, instance, created, **kwargs):
    ...
    from know.models import Question, Response
