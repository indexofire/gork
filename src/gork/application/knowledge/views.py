...
from know.models import Question, Response, Category
from know.forms import QuestionForm, ResponseForm
from know.utils import paginate
...
def knowledge_list(request, category_slug=None, template=None, Form=QuestionForm):
    template = 'know/list.html'
...
def knowledge_thread(request, question_id, slug=None, template=None, Form=ResponseForm):
    template = 'know/thread.html'
...
def knowledge_ask(request, template='know/ask.html', Form=QuestionForm):
