...
from gmessage.utils import format_subject, format_quote
...
class IntegrationTestCase(TestCase):
    ...
    def testInboxEmpty(self):
        ...
        self.assertEquals(response.template[0].name, 'gmessage/inbox.html')
    ...
    def testOutboxEmpty(self):
        ...
        self.assertEquals(response.status_code, 200)
        self.assertEquals(response.template[0].name, 'gmessage/outbox.html')
        self.assertEquals(len(response.context['message_list']), 0)
    ...
    def testTrashEmpty(self):
        ...
        self.assertEquals(response.status_code, 200)
        self.assertEquals(response.template[0].name, 'gmessage/trash.html')
        self.assertEquals(len(response.context['message_list']), 0)
    ...
    def testCompose(self):
        ...
        self.assertEquals(response.status_code, 200)
        self.assertEquals(response.template[0].name, 'gmessage/compose.html')
