...
EMAIL_SUBJECT = getattr(django_settings, 'NOTIFY_EMAIL_SUBJECT', _("You have new notifications"))

EMAIL_SENDER = getattr(django_settings, 'NOTIFY_EMAIL_SENDER', "notifications@example.com")
